          ...
          <div class="panel-body container-fluid">
            <div class="row">
              <div class="form-group form-material">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control <?php echo ($arrdata['NO_CONT']!="")?"focus":""; ?>" value="<?php echo $arrdata['NO_CONT']; ?>" readonly="readonly" maxlength="11">
              ...
              <div class="panel-body container-fluid">
                <div class="row">
                  <div class="form-group form-material">
                    <label class="col-sm-3 control-label">LOKASI TIMBUN</label>
                    <div class="col-sm-9">
                      <input type="text" name="DATA[KD_TIMBUN]" id="KD_TIMBUN" class="form-control" value="<?php echo $arrdata['KD_TIMBUN']; ?>">
                      <div class="hint">LOKASI TIMBUN</div>
                    </div>
                  </div>
                  <div class="form-group form-material">
                  ...
                  <?php /*?><div class="form-group form-material">
                    ...
                    <div class="col-sm-1">
                      <button type="button" class="btn btn-primary btn-sm" onclick="popup_searchtwo('popup/popup_search/mst_dokbc|EXP/KD_DOK_OUT|JENIS_DOK_OUT/2');"><span class="icon md-search"></span></button>
                    </div>
                  </div>
                  <div class="form-group form-material">
                    <label class="col-sm-3 control-label">DOKUMEN</label>
