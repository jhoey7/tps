<div class="panel">
  ...
  <button type="submit" class="btn btn-sm btn-primary navbar-right navbar-btn waves-effect waves-light" onclick="process('form_data','execute/process/read/coarri/discharge'); return false;"> <i class="icon md-dot-circle"></i> PROCESS </button>
          ...
          <div class="panel">
            ...
            <div class="panel-collapse collapse in" id="CollapseOne" aria-labelledby="HeadingOne"
              ...
              <div class="panel-body">
                <form name="form_data" id="form_data" class="form-horizontal" role="form" action="execute/process/upload/coarri/discharge" method="post" autocomplete="off" enctype="multipart/form-data">
                  <div class="panel-body container-fluid">
                        ...
                        <div class="input-group input-group-file">
                          ...
                          <span class="input-group-btn">
                          	<span class="btn btn-primary btn-file files">
                          		...
                          		<input type="file" name="files" id="files" class="files" readonly="readonly" mandatory="yes">
                          	</span>
                          </span>
                      	</div>
                      </div>
                      <div class="col-sm-2">
                      	<a href="<?php echo site_url('execute/download/excel/discharge'); ?>" class="btn btn-primary" data-toggle="tooltip" title="FORMAT EXCEL">
                  ...
                  <input type="hidden" name="action" id="action" readonly="readonly" value="<?php echo site_url('coarri/discharge'); ?>"/>
                </form>
              </div>
            </div>
          </div>
