<div class="panel">
  ...
  <button type="submit" class="btn btn-sm btn-primary navbar-right navbar-btn waves-effect waves-light" onclick="process('form_data','execute/process/read/codeco/gatein'); return false;"> <i class="icon md-dot-circle"></i> PROCESS </button>
                ...
                <form name="form_data" id="form_data" class="form-horizontal" role="form" action="execute/process/upload/codeco/gatein" method="post" autocomplete="off" enctype="multipart/form-data">
                  <div class="panel-body container-fluid">
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <div class="input-group input-group-file">
                          ...
                          <span class="input-group-btn">
                              <span class="btn btn-primary btn-file" class="files">
                      ...
                      <div class="col-sm-2">
                      	<a href="<?php echo site_url('execute/download/excel/gatein'); ?>" class="btn btn-primary" data-toggle="tooltip" title="FORMAT EXCEL">
                  ...
                  <input type="hidden" name="action" id="action" readonly="readonly" value="<?php echo site_url('codeco/gatein'); ?>"/>
                </form>
              </div>
            </div>
          </div>
