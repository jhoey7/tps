...
<script type="text/javascript">
	...
	$(document).ready(function(){
		var so = new SWFObject("<?php echo base_url(); ?>assets/dashboard/ampie/ampie.swf", "chartGatein", "100%", "600", "8");
		...
		setInterval(function() {
			var url = site_url + "dashboard/charts_update/gate_in/"+Math.ceil(Math.random()*1000);
	...
	function updateData(dataUpdate){
		if ($('#chartGatein').length > 0)
			document.getElementById("chartGatein").setData(dataUpdate);
	}
</script>
