...
<div id="flashcontent" style="height:100px"><strong>Silahkan Update Flash Player Anda</strong></div>
<script type="text/javascript">
	var base_url = '<?php echo base_url(); ?>';
	var site_url = '<?php echo site_url(); ?>/';
	$(document).ready(function(){
		var so = new SWFObject("<?php echo base_url(); ?>assets/dashboard/ampie/ampie.swf", "chartDischarge", "100%", "600", "8");
		...
		setInterval(function() {
			var url = site_url + "dashboard/charts_update/discharge/"+Math.ceil(Math.random()*1000);
	...
	function updateData(dataUpdate){
		if ($('#chartDischarge').length > 0)
			document.getElementById("chartDischarge").setData(dataUpdate);
	}
</script>
