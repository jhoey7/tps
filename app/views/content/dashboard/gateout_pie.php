...
<script type="text/javascript">
	...
	$(document).ready(function(){
		var so = new SWFObject("<?php echo base_url(); ?>assets/dashboard/ampie/ampie.swf", "chartGateout", "100%", "600", "8");
		...
		setInterval(function() {
			var url = site_url + "dashboard/charts_update/gate_out/"+Math.ceil(Math.random()*1000);
	...
	function updateData(dataUpdate){
		if ($('#chartGateout').length > 0)
			document.getElementById("chartGateout").setData(dataUpdate);
	}
</script>
